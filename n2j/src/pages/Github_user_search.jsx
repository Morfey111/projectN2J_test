      ...
      <div className="w-11/12 mx-auto px-2 md:w-9/12 md:px-0 xl:w-7/12">
        ...
        <div className="bg-white mt-5 rounded-xl ">
          ...
          <div className=" text-gitText xl:grid xl:grid-cols-5  dark:bg-gitDarkGray dark:text-white">
            <div className="flex w-10/12 mx-auto py-7 text-sm md:text-base xl:col-start-1 xl:col-end-6 xl:grid xl:grid-cols-5">
              <img
                src={avatar}
                className="w-24 md:w-32 mr-5 xl:col-start-1 xl:-ml-3"
              />

              <div className="xl:grid xl:columns-5 xl:col-start-2 xl:col-end-6">
                <p className="text-gitTitle dark:text-white text-le font-bold pb-1 xl:ml-3 md:text-2xl">
                  The Octocat
                </p>
                <p className="text-gitEmail pb-1 xl:col-start-1 xl:ml-3">
                  @octocat
                </p>
                <p className="pb-1 xl:col-end-6 xl:row-start-1 text-right">
                  Joined 25 Jan 2011
                </p>
              </div>
            </div>
            ...
            <div className="xl:col-start-2 xl:col-end-6">
              ...
              <div className="bg-gitMain  dark:bg-gitDarkMine dark:text-white flex justify-between w-10/12 mx-auto p-5 rounded-xl my-7">
                <div>
                  ...
                  <p className="text-base font-bold text-gitTitle  dark:text-white">
                    8
                  </p>
                </div>
                <div>
