import { StyledHeader } from './syles/Styles_Landing_page_ez_header';
import '@fontsource/ibm-plex-sans/400.css'; // Specify weight

function Landing_page_ez_header() {
  return (
    <div>
      <StyledHeader>
        <div className="md:flex justify-between mb-10 xl:pb-2  ">
          <svg
            className="mt-4"
          ...
          <div>
            <svg
              className="hidden md:-mr-10 md:inline -mt-8 xl:mr-0"
              xmlns="http://www.w3.org/2000/svg"
              width="312"
              height="468"
            >
        ...
        <div className="md:w-8/12 md:-mt-64 xl:w-9/12 xl:max-w-5xl ">
          <p className="md:text-7xl md:mb-10 xl:text-8xl font-bold mb-2 text-5xl">
            We make your music sound extraordinary.
          </p>
          <p className="text-lg mb-32 xl:text-xl">
...
export default Landing_page_ez_header;
