...
import { Nav } from './syles/Styled_page_abv_nav';

function Landing_page_adv_header() {
  const Links = [
    { name: 'About', link: '#' },
    { name: 'Careers', link: '#' },
    { name: 'Events', link: '#' },
  ...
  return (
    <div className="bg-[url('.\images\page_abv\mobile\image-hero.jpg')] bg-cover pb-36 p-2 lg:bg-[url('.\images\page_abv\desktop\image-hero.jpg')]">
      <div className="flex justify-between w-11/12 mx-auto items-center mb-28 pt-8  lg:w-10/12">
        ...
        <ul
          className={`lg:flex lg:items-center text-white absolute lg:static lg:mt-0 lg:pt-5 lg:normal-case lg:bg-opacity-0 left-0 w-full bg-black pt-48 pl-5 lg:justify-end ${
            open
              ? 'top-14 uppercase pb-36 duration-500'
              : 'top-[-490px] duration-500'
          } `}
        >
          {Links.map((list) => {
            return (
      ...
      <div className="lg:w-10/12 mx-auto">
        <div className="uppercase text-white text-4xl w-11/12 mx-auto border-2 font-light	p-7 flex flex-wrap flex-col sm:flex-row lg:max-w-xl lg:p-8 lg:mx-0  ">
          <div className="w-40 sm:w-72  lg:text-6xl lg:w-full  ">
...
export default Landing_page_adv_header;
